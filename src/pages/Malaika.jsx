  ...
  return (
    <>
      <section className="profile_page">
        <div className={`malaika_arora_profile_background ${showPopUp ? 'blur-background' : ''}`}>
          {/* <img src={Profile_back} alt="" /> */}
        </div>
     {showPopUp && (<div className="popup_info">
     <div className="malaika_arora_profile_background popup_background">
          {/* <img src={Profile_back} alt="" /> */}
        </div>
    ...
    <p className="first_para">
            Discover the Art of Glamour with <b>Malaika Arora</b>: Elevate your
          ...
          <div className="second_para">
            <ul>
              ...
              Malaika Arora: Elevate your journey
       ...
       {/* </Link> */}
        <div className="malaika_profile_pic"></div>
        <div className="name_details">
          <b className="profile_name">Malaika Arora</b>
